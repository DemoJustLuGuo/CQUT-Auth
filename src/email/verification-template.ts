...
import type { SendVerificationCodeInput } from "./email-sender.js";

export type RenderedVerificationEmail = {
  subject: string;
  text: string;
  html: string;
};
...
/**
 * Single source of truth for the verification email body so every delivery
 * provider (Resend, SMTP, ...) sends an identical message.
 */
